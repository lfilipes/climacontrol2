...
import { temperatureTS,humidityTS,presenceTS,onoffTS,powerp1TS,tempLastRead,pwrLastRead  } from '../../models/timeSeries.class';
...
//        console.log('pwrDevLatest: ====>', this.pwrDevLatest[0].powerp1[0].value);
//        console.log('tempDevLatest: ====>', this.tempDevLatest[0]);    
